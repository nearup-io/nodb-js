...
export const projectTitan: Project = {
  title: "Project Titan",
  description: "Development of a cutting-edge AI-driven analytics platform",
  team_members: ["Emily White", "David Garcia", "Sophia Wang"],
  priority: "High",
